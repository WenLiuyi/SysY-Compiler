...
define dso_local i32 @func_cond() #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @test_if() #0 {
  %1 = call i32 @func_cond()
  %2 = icmp ne i32 %1, 0
...
8:                                                ; preds = %7, %4, %3, %0
  %9 = call i32 @func_cond()
  %10 = icmp ne i32 %9, 0
  br i1 %10, label %11, label %15

11:                                               ; preds = %8
  br i1 true, label %15, label %12

12:                                               ; preds = %11
  %13 = call i32 @func_cond()
  %14 = icmp ne i32 %13, 0
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0))
  call void @test_if()
  %3 = load i32, i32* @global, align 4
  %4 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 noundef %3)
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
...
define dso_local i32 @getchar() #0 {
  %1 = alloca i8, align 1
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* noundef %1)
...
define dso_local i32 @getint() #0 {
  %1 = alloca i32, align 4
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.4, i64 0, i64 0), i32* noundef %1)
  br label %3
...
define dso_local i32 @getarray(i32* noundef %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.4, i64 0, i64 0), i32* noundef %3)
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.4, i64 0, i64 0), i32* noundef %14)
  br label %16

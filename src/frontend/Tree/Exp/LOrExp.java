...
public class LOrExp extends Node{
    public LOrExp(Grammar grammar,int lineno){
        super(grammar,lineno);
    }
    public void match(String token,LexType lexType){}

    public void create_LAndExp(Grammar grammar,int lineno){
        LAndExp lAndExp = new LAndExp(grammar,lineno);
        this.next.add(lAndExp);lAndExp.pre=this;this.visited++;
        this.grammar.curNode=lAndExp;
        lAndExp.create_EqExp(grammar,lineno);
    }
    @Override

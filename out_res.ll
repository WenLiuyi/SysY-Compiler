...
@var_int_array = dso_local global [5 x i32] [i32 1, i32 1, i32 0, i32 0, i32 0]
...
define dso_local i32 @getint() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* noundef %1)
  br label %3
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* noundef %14)
  br label %16
...
define dso_local i32 @main() {
  ...
  %5 = getelementptr inbounds [5 x i32], [5 x i32]* @var_int_array, i32 0, i32 1
  %6 = load i32, i32* %5, align 4
  %7 = getelementptr inbounds [5 x i32], [5 x i32]* %1, i32 0, i32 1

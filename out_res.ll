...
@.str.6 = private unnamed_addr constant [10 x i8] c"21376218\0A\00"
@.str.1.7 = private unnamed_addr constant [2 x i8] c"\0A\00"
@.str.2.8 = private unnamed_addr constant [14 x i8] c"Finish test1\0A\00"
...
define dso_local i32 @main() {
  ...
  call void @putstr(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1.7, i64 0, i64 0))
  call void @putstr(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2.8, i64 0, i64 0))
  ret i32 0
}
